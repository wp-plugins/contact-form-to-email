...
[<a href="http://wordpress.dwbooster.com/support?product=contact-form-to-email&ref=dashboard" target="_blank">Request Custom Modifications</a>] | [<a href="<?php echo $this->plugin_URL; ?>" target="_blank">Help</a>]
</form>
</div>
